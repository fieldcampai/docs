...
4. **Fill Out Form Details**:
   ...
   ![Screenshot 8 Pn](/images/Screenshot_8.png)

When creating a job form in FieldCamp, you’ll need to select the type of form-either Jobs or Products and Services. This ensures your form is tailored to the specific workflow, whether you’re capturing details for a service job or documenting information related to products and services
