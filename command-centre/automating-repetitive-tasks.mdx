---
title: "Automating Tasks with AI-Powered Command Centre"
description: "Learn how to use FieldCamp’s AI-powered Command Centre to automate repetitive tasks with natural language commands. Save time by managing schedules, clients, and services effortlessly."
---
...
<iframe width="650" height="400" src="https://www.youtube.com/embed/xmKDbbxeifY?si=Yd9qS_OlTSEM60BW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
![slash commands](/images/slashcommands.png "FieldCamp Commands")
